  ...
  return (
    ...
    >
      ...
      <Flex m="2" p="2" direction="row" align={["end", "flex-center"]} justify={["center", "flex-end"]} >
        {Auth.loggedIn() ? (
          <>
            <Button as={ReactLink} variant="secondary" m="0.5" to="/profile">
              Me
            </Button>
            <Button variant="secondary" m="0.5" onClick={logout}>
              Logout
            </Button>
            <Button variant="primary" m="0.5" onClick={toggleColorMode}>
              🌙
            </Button>
          </>
        ) : (
